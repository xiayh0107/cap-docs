...
This repository contains one drafted CAP profile and one reserved upper layer.
...
| CAP-Core | `specs/core/` | reserved | no | Not yet drafted; only problem framing is recorded. |
...
CAP-Core content must remain non-normative until the CAP-Core process formally starts.
