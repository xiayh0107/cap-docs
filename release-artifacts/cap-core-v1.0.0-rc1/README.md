...
This package is the CAP-Core v1.0.0 release candidate artifact set.
...
python reference/python/scripts/package_core_release_artifacts.py --release cap-core-v1.0.0-rc1
python reference/python/scripts/validate_core_release_manifest.py release-artifacts/cap-core-v1.0.0-rc1
```
