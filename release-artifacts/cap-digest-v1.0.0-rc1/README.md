# cap-digest-v1.0.0-rc1

This package is the CAP-Digest v1.0.0 release-candidate artifact set.
...
python reference/python/scripts/validate_digest_release_manifest.py release-artifacts/cap-digest-v1.0.0-rc1
```
