---
name: table-basic
description: Use this digest pack for tabular sources when an agent needs shape, column names, column types, compact examples, redaction caveats, or sample rows. Do not use it for chart image interpretation, SQL execution, or CAP-Core runtime binding.
